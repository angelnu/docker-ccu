...
DOCKER_START_OPTS="--name $DOCKER_NAME -p ${CCU2_REGA_PORT}:80 -p ${CCU2_RFD_PORT}:2001 -e PERSISTENT_DIR=${DOCKER_VOLUME_INTERNAL_PATH} --hostname $DOCKER_NAME $DOCKER_OPTIONS $DOCKER_ID"
